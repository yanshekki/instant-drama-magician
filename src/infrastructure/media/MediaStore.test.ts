...
describe('MediaStore', () => {
  ...
  it('exposes root and story layout paths', () => {
    ...
    expect(store.spatialIdentityDir('s1', 'e1')).toContain('identity')
    expect(store.spatialMeshDir('s1', 'e1')).toContain('mesh')
    expect(store.spatialMeshPath('s1', 'e1', 'p1')).toContain('p1.gltf')
