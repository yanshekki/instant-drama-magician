...
export const ptBrPromptCopy: PromptCopyTable = {
  ...
  "sceneIntro.camera": "Câmera: {{camera}}; set vazio preferível; sem rostos novos nem logos.",
  ...
  "actionIntro.closing": "Movimento contínuo, cinematográfico, sem texto; siga o still.",
