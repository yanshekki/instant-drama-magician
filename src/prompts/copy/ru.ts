...
export const ruPromptCopy: PromptCopyTable = {
  ...
  "sceneIntro.camera": "Камера: {{camera}}; пустой сет предпочтителен; без новых лиц и логотипов.",
  ...
  "actionIntro.closing": "Плавное кинодвижение, без текста; следуй кейфрейму.",
