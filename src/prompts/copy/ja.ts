...
export const jaPromptCopy: PromptCopyTable = {
  "speechLock.named": "SPEECH LOCK · キャラクター「{{who}}」：聞こえる音声と口の動きは必ず{{primaryName}}（{{primary}}）のみ。{{forbid}}や他言語に切り替えるな。クリップごとに言語を変えるな。台詞を翻訳するな。",
  "speechLock.unnamed": "SPEECH LOCK · 出演キャラクター：聞こえる音声と口の動きは必ず{{primaryName}}（{{primary}}）のみ。{{forbid}}や他言語に切り替えるな。クリップごとに言語を変えるな。台詞を翻訳するな。",
  "speechLock.namedMulti": "SPEECH LOCK · キャラクター「{{who}}」：聞こえる音声と口の動きは必ず{{primaryName}}（{{primary}}）。台本のその行が既にその言語である場合のみ第二言語を許可：{{extras}}。第三言語は禁止。クリップ間で切り替えるな。{{forbid}}へ変えるな。台詞を翻訳するな。",
  "speechLock.unnamedMulti": "SPEECH LOCK · 出演キャラクター：聞こえる音声と口の動きは必ず{{primaryName}}（{{primary}}）。台本のその行が既にその言語である場合のみ第二言語を許可：{{extras}}。第三言語は禁止。クリップ間で切り替えるな。{{forbid}}へ変えるな。台詞を翻訳するな。",
  ...
  "still.regenTask": "任務：image-to-video 監督プロンプトを改訂し、キーフレーム概要としても使えるようにせよ。",
  ...
  "actionIntroPolish.templateKeepRules": "テンプレート下書き（磨け；HARD RULES は末尾）：",
  ...
  "tpl.system.invent": "レシピ invent：ユーザーが自由創作を許した。撮れる细节で必須欄を埋めよ。Demo や本リクエストに無い世界は持ち込むな。",
