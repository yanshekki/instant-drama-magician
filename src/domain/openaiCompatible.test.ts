...
describe('openaiCompatible presets', () => {
  ...
  it('image/video capable filters and special channels', () => {
    ...
    expect(isSpecialChannelProvider('stable-diffusion')).toBe(true)
    expect(isSpecialChannelProvider('openai')).toBe(false)
    expect(isImageCapableProvider('stable-diffusion')).toBe(true)
    expect(isVideoCapableProvider('stable-diffusion')).toBe(true)
