...
describe('channelManifest', () => {
  it('has 190 desktop channels unique', () => {
    expect(DESKTOP_CHANNEL_NAMES.length).toBe(190)
    expect(new Set(DESKTOP_CHANNEL_NAMES).size).toBe(190)
    expect(CORE_CHANNELS.length).toBe(190)
  })
