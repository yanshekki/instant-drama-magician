...
<p align="center">
  ...
  <a href="#cli-instant-drama"><img src="https://img.shields.io/badge/CLI-190%20channels-238636?style=flat-square" alt="CLI"></a>
...
| Desktop | Remote | CLI |
|---|---|---|
| Linux · Windows · macOS (Electron) | Same project in the browser | `instant-drama` — **190** channels, same as the app |
...
From the running app (`src/assets/screen/`, v1.11.3). The heroes above are the **timeline**, **comics**, and **key-art** desks.
...
| **CLI `instant-drama`** | Local headless or remote invoke; build/open desktop app; OpenClaw / Hermes agents (**190** IPC channels) |
...
instant-drama update install 1.11.3 --yes   # pin a version
```
...
instant-drama channels list --json          # ~190 channels
```
...
```bash
# Diagnostics (channel count should be ~190)
instant-drama doctor --json
...
| [docs/blender.md](./docs/blender.md) | [docs/blender-ZH.md](./docs/blender-ZH.md) | Blender spatial add-on |
