...
From the running app (`src/assets/screen/`, v1.10.0). The heroes above are the **timeline**, **comics**, and **key-art** desks.
...
instant-drama update install 1.10.0 --yes   # pin a version
```
