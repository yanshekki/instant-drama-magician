...
From the running app (`src/assets/screen/`, v1.11.1). The heroes above are the **timeline**, **comics**, and **key-art** desks.
...
instant-drama update install 1.11.1 --yes   # pin a version
```
