...
The Electron desktop app remains available; Web and desktop share the same business handlers (**184** channels).
...
| GET | `/api/channels` | Registered channel list (**184**) |
...
- **NOT_FOUND channel** → upgrade server; expect **184** channels  
