...
The Electron desktop app remains available; Web and desktop share the same business handlers (**190** channels).
...
| GET | `/api/channels` | Registered channel list (**190**) |
...
- **NOT_FOUND channel** → upgrade server; expect **190** channels  
