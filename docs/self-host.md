...
The Electron desktop app remains available; Web and desktop share the same business handlers (**189** channels).
...
| GET | `/api/channels` | Registered channel list (**189**) |
...
- **NOT_FOUND channel** → upgrade server; expect **189** channels  
