...
Product version **1.11.4** · Vendor **YSK Limited** · Contact **[email@ysk.hk](mailto:email@ysk.hk)**
...
| Fact | Value |
|------|--------|
| App version | `1.11.4` (`package.json`) |
| IPC / CLI channels | **190** (shared `registerAllHandlers`) |
...
| Dev userData (Linux) | Same OS folder (`~/.config/instant-drama-magician/`) unless `IDM_DATA_DIR` / `IDM_PROFILE` |
