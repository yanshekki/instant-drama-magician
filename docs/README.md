...
Product version **1.5.0** · Vendor **YSK Limited** · Contact **[email@ysk.hk](mailto:email@ysk.hk)**
...
| Fact | Value |
|------|--------|
| App version | `1.5.0` (`package.json`) |
| IPC / CLI channels | **167** (shared `registerAllHandlers`) |
