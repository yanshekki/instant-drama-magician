...
Product version **1.4.2** · Vendor **YSK Limited** · Contact **[email@ysk.hk](mailto:email@ysk.hk)**
...
| Fact | Value |
|------|--------|
| App version | `1.4.2` (`package.json`) |
| IPC / CLI channels | **158** (shared `registerAllHandlers`) |
