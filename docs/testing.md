...
| Spatial shot-stage | `spatialRef.test.ts`, `spatialPackage.test.ts`, `spatialPlayblast.test.ts`, `spatialMesh.test.ts`, `spatial.test.ts`, `TimelineShotStage.test.tsx`, `TimelineSpatialPanel.test.tsx` |
