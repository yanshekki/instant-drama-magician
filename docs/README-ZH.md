...
產品版本 **1.11.4** · 廠商 **YSK Limited** · 聯絡 **[email@ysk.hk](mailto:email@ysk.hk)**
...
| 項目 | 值 |
|------|-----|
| App 版本 | `1.11.4`（`package.json`） |
| IPC／CLI channel | **190**（共用 `registerAllHandlers`） |
...
完整圖庫（故事 → 章節 → 選角 → 漫畫 → 劇照 → 時間軸 → 設定）見根目錄 [README-ZH](../README-ZH.md#介面預覽)。時間軸流程圖即同一套故事的三條工作檯：

<p align="center">
  <img src="../src/assets/screen/7.png" alt="時間軸流程圖" width="100%">
</p>
