...
截圖來自實際應用（`src/assets/screen/`，v1.11.4）。上方主圖是 **時間軸**、**漫畫** 與 **劇照** 三張工作檯。
...
```bash
# Linux 範例
sudo dpkg -i release/instant-drama-magician_1.11.4_amd64.deb
# 或
...
instant-drama update install 1.11.4 --yes   # 釘選版本
```
